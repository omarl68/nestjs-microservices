          ...
          <div id="kc-form-wrapper">
            <#if realm.password>
                <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                    <#if !usernameHidden??>
                        <div class="${properties.kcFormGroupClass!} custom-rtl">
                    ...
                    <div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
                        <div id="kc-form-options">
                            <#if realm.rememberMe && !usernameHidden??>
                                <div class="checkbox" style="display: flex; justify-content: center; gap: 8px; align-items: center">
                                 <label for="rememberMe" style="padding: 0px" class="remember-me-label"> 
                                    <div class="switch">
                                        <#if login.rememberMe??>
                            ...
                            <div class="${properties.kcFormOptionsWrapperClass!}">
                                <#if realm.resetPasswordAllowed>
                                    <span><a tabindex="6" href="${url.loginResetCredentialsUrl}" class="forget-password-link">${msg("doForgotPassword")}</a></span>
                                </#if>
                            </div>
